...
export const CREATE_ACCOUNT_SUCCESS_MESSAGE =
  "✅ New account created successfully, But it needs to be approved by your admin.";
export const CREATE_ACCOUNT_ERROR_MESSAGE =
  "❌ Error happened while trying to create new account";
